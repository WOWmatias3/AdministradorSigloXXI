...
namespace DAL
{
    public class PedidoDAL
    {
        ...
        public DataTable Get_detPediById_ingredientes(int id_pe)
        {
            using (OracleConnection con = new Conexion().conexion())
            {
                OracleCommand cm = new OracleCommand("get_DetaPedidoById", con);
                cm.BindByName = true;
                cm.CommandType = System.Data.CommandType.StoredProcedure;
                cm.Parameters.Add("id_pe", OracleDbType.Int32).Value = id_pe;
                OracleParameter output = cm.Parameters.Add("my_cursor", OracleDbType.RefCursor);
        ...
        public DataTable Get_detPediById_bebestible(int id_pe)
        {
            using (OracleConnection con = new Conexion().conexion())
            {
                OracleCommand cm = new OracleCommand("get_DetaPedidoById_bebestible", con);
                cm.BindByName = true;
                cm.CommandType = System.Data.CommandType.StoredProcedure;
                cm.Parameters.Add("id_pe", OracleDbType.Int32).Value = id_pe;
                OracleParameter output = cm.Parameters.Add("my_cursor", OracleDbType.RefCursor);
        ...
        public DataTable MaterPedido(string tipo, string estado,string rango)
        {
            using (OracleConnection con = new Conexion().conexion())
            {
                OracleCommand cm = new OracleCommand("Master_Pedidos", con);
                cm.BindByName = true;
                cm.CommandType = System.Data.CommandType.StoredProcedure;
                cm.Parameters.Add("tipo", OracleDbType.Varchar2).Value = tipo;
                cm.Parameters.Add("estado", OracleDbType.Varchar2).Value = estado;
                cm.Parameters.Add("rango", OracleDbType.Varchar2).Value = rango;
                OracleParameter output = cm.Parameters.Add("my_cursor", OracleDbType.RefCursor);
                output.Direction = System.Data.ParameterDirection.ReturnValue;
                con.Open();
                try
        ...
        public void Alter_detalle_pedido(int cant, int id_prov, int monto, int id_ins, int id_ped)
        {
            try
            {
                using (OracleConnection con = new Conexion().conexion())
                {
                    ...
                    objCmd.CommandText = "ALTER_DETALLEPEDIDO";
                    objCmd.CommandType = CommandType.StoredProcedure;
                    objCmd.Parameters.Add("cant", OracleDbType.Int32).Value = cant;
                    objCmd.Parameters.Add("id_prov", OracleDbType.Int32).Value = id_prov;
                    objCmd.Parameters.Add("monto", OracleDbType.Int32).Value = monto;
                    objCmd.Parameters.Add("id_ins", OracleDbType.Int32).Value = id_ins;
                    objCmd.Parameters.Add("id_ped", OracleDbType.Int32).Value = id_ped;
                    con.Open();
